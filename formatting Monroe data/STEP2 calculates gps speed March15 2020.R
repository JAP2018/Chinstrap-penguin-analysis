...
setwd("C:/Users/Jessica/Desktop/Chinstrap analysis Feb8 2020/1.3 15_16 analysis Feb8 2020")
data <- read.csv("15_16_all_gps_at_sea_Dec11.csv")
...
write.csv(file = "15_16_gpssea_speed_March15 2020.csv", data)  
