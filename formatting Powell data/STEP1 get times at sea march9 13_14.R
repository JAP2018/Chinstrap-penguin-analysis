...
setwd("C:/Users/Jessica/Desktop/penguin data/2013-2014/Powell Island/Tracking data")
for(i in 1:length(master[,1])){
  ...
  one_file$id <-paste("13_14",substr(call_file,71,71),substr(call_file,78,79),sep="_")
  if (i==1){
    data <-one_file
  }
  else{
...
data <- data[,c("id","POSIXct","LAT","LON","C")] 
...
write.table(trip_info,file="trip_info_13_14_Dec5.csv", sep = ",",row.names = FALSE)
